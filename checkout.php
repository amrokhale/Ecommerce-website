...
if(isset($_POST['order'])){
   ...
   $address = 'flat no. '. htmlspecialchars($_POST['flat'], ENT_QUOTES, 'UTF-8') .', '. htmlspecialchars($_POST['street'], ENT_QUOTES, 'UTF-8') .', '. htmlspecialchars($_POST['city'], ENT_QUOTES, 'UTF-8') .', '. htmlspecialchars($_POST['state'], ENT_QUOTES, 'UTF-8') .', '. htmlspecialchars($_POST['country'], ENT_QUOTES, 'UTF-8') .' - '. filter_var($_POST['pin_code'], FILTER_SANITIZE_NUMBER_INT);
